...
static struct SceUdcdStringDescriptor string_descriptors[2] = {
    {20, USB_DT_STRING, {'V', 'i', 't', 'a', 's', 't', 'i', 'c', 'k'}},
    {0, USB_DT_STRING}};
...
/* Hi-Speed settings */
static struct SceUdcdInterfaceSettings settings_hi[1] = {
    {&interdesc_hi[0], 0, 1}};
...
static struct SceUdcdConfigDescriptor confdesc_hi = {
    USB_DT_CONFIG_SIZE,
    USB_DT_CONFIG,
    (USB_DT_INTERFACE_SIZE + USB_DT_CONFIG_SIZE + USB_DT_ENDPOINT_SIZE +
     sizeof(hiddesc)), /* wTotalLength */
    1,                 /* bNumInterfaces */
...
static struct SceUdcdConfiguration config_hi = {
    &confdesc_hi, &settings_hi[0], &interdesc_hi[0], &endpdesc_hi[0]};
...
/* Full-Speed settings */
static struct SceUdcdInterfaceSettings settings_full[1] = {
